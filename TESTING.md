...
| Issue                 | Screenshot |
| --------------------- | --- | 
 When an equation has been undone using the undo button, the numbers used will become avaialbe for re-use, however the undo button doesn't remove the strike through on the numbers so they may appear to be unavailable and out of use. | ![screenshot](documentation/bugs/bug-uno-1.png)![screenshot](documentation/bugs/bug-undo-2.png)  ![screenshot](documentation/bugs/bug-undo-3.png) |
