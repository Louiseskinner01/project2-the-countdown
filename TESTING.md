...
Used numbers   | Play a game and input some equations using the numbers generated by the game.     | Once a number has been used, it becomes unavailable and is struck through with a line. | ✅ Works          |  ![screenshot](documentation/features/navbar-toggle.png) ![screenshot](documentation/features/used-numbers.png) |
...
| --- | --- | --- | --- | --- | --- |
|  | [404.html](https://github.com/Louiseskinner01/project2-the-countdown/blob/main/404.html) | [HTML Validator](https://validator.w3.org/nu/?doc=https://louiseskinner01.github.io/project2-the-countdown/404.html) | ![screenshot](documentation/validation/html/html-404-errors.png) | ![screenshot](documentation/validation/html/html-404-valid.png) | The errros preventing this page from passing validation were things such as stray / at the end of tags e.g `    <meta charset="UTF-8" />`. By removing the unecessary white space, the erro was easily fixed. |
...
|  | [index.html](https://github.com/Louiseskinner01/project2-the-countdown/blob/main/index.htmll) | [HTML Validator](https://validator.w3.org/nu/?doc=https://louiseskinner01.github.io/project2-the-countdown/index.html) | ![screenshot](documentation/validation/html/html-index-errors.png) | ![screenshot](documentation/validation/html/html-index-valid.png) | stray `</i>` tags in the footer was a common theme throughout, and was the only error identified whilst testing this page. |
|  | [registration.html](https://github.com/Louiseskinner01/project2-the-countdown/blob/main/registration.html) | [HTML Validator](https://validator.w3.org/nu/?doc=https://louiseskinner01.github.io/project2-the-countdown/registration.html) | ![screenshot](documentation/validation/html/html-registration-erros.png) | ![screenshot](documentation/validation/html/html-registration-valid.png) | The most semantic of errors was on this oage, where an a tag was the child element of a button. To fix this I removed the a tag, and added a link to the form-submitted.html page to the registration forms action attribute like this `action="form-submitted.html"`. |
|  | [practice.html](https://github.com/Louiseskinner01/project1-lskinner/blob/main/nutrition.html) | [HTML Validator](https://validator.w3.org/nu/?doc=https://louiseskinner01.github.io/project2-the-countdown/practice.html) | ![screenshot](documentation/validation/html/html-practice-errors.png) | ![screenshot](documentation/validation/html/html-practice-valid.png) | Stray `</i>` was the culprit. |
|  | [instructions.html](https://github.com/Louiseskinner01/project2-the-countdown/blob/main/instructions.html) | [HTML Validator](https://validator.w3.org/nu/?doc=https://louiseskinner01.github.io/project2-the-countdown/instructions.html) | ![screenshot](documentation/validation/html/html-instructions-erros.png) |  ![screenshot](documentation/validation/html/html-instructions-valid.png) | The main cuplprits here were stray `</i>` and `</div>` tags. |
...
| --- | --- | --- | --- | --- |
| assets | [stylesheet.css](https://github.com/Louiseskinner01/project2-the-countdown/blob/main/assets/css/stylesheet.css) | [CSS Validator](https://jigsaw.w3.org/css-validator/validator?uri=https://louiseskinner01.github.io/project2-the-countdown/assets/css/stylesheet.css&output=html) | ![screenshot](documentation/validation/css/stylesheet-url-error.png) ![screenshot](documentation/validation/css/stylesheet-url-error1-fixed.png) ![screenshot](documentation/validation/css/stylesheet-upload-valid.png) | When validating my CSS, the file upload and copy-and-paste methods passed with no errors. However, using the GitHub URL produced several validation errors, likely due to external factors or differences in how the file was accessed. |
|  | [workingout-grid.css](https://github.com/Louiseskinner01/project1-lskinner/blob/main/assets/css/new-stylesheet.css) | [CSS Validator](https://jigsaw.w3.org/css-validator/validator?uri=https://louiseskinner01.github.io/project2-the-countdown/assets/css/workingout-grid.css&output=html) | ![screenshot](documentation/validation/css/workingout-grid-url-errors.png) ![screenshot](documentation/validation/css/workingout-grid-upload-valid.png) | same as above|
...
|  | [global-variables.css](https://github.com/Louiseskinner01/project1-lskinner/blob/main/assets/css/new-stylesheet.css) | [CSS Validator](https://jigsaw.w3.org/css-validator/validator?uri=https://louiseskinner01.github.io/project2-the-countdown/assets/css/global-variables.css&output=html) | ![screenshot](documentation/validation/css/global-variables-url-errors.png) ![screenshot](documentation/validation/css/global-variables-upload-valid.png) | same as above |
...
|  | [orientation.js](https://github.com/Louiseskinner01/project2-the-countdown/blob/main/assets/js/orientation.js) | ![screenshot](documentation/validation/js/orientation-warnings-none.png)  | ` /* jshint esversion: 6 */` |
...
| 404 | ![screenshot](documentation/lighthouse-performance/mobile/lighthouse-404-good.png) | ![screenshot](documentation/lighthouse-performance/desktop/lighthouse-dt-404.png) | Due to the erros found and corrections made on previous pages, there wasn't anything major effecting this page, resulting in an overal good performance level. |
