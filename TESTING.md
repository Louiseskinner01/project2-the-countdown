...
| --- | --- | --- | --- | --- | --- | --- |
| Index.html (Home - Rotate Warning)  | ![screenshot](documentation/browser/chrome/chrome-index-rotate.png) | ![screenshot](documentation/browser/firefox/firefox-index-rotate.png) | ![screenshot](documentation/browser/safari/safari-index-rotate.png) | ![screenshot](documentation/browser/edge/edge-index-rotate.png) | ![screenshot]() | Works as expected |
| Index.html (Home - PLAY?)  | ![screenshot](documentation/browser/chrome/chrome-index-play.png) | ![screenshot](documentation/browser/firefox/firefox-index-play.png) | ![screenshot](documentation/browser/safari/safari-index-play.png) |  ![screenshot](documentation/browser/edge/edge-index-play.png) | ![screenshot]() | Works as expected |
| Index.html (Home - During Play)  | ![screenshot](documentation/browser/chrome/chrome-index-during-play.png) | ![screenshot](documentation/browser/firefox/firefox-index-during-play.png) | ![screenshot](documentation/browser/safari/safari-index-during-play.png) | ![screenshot](documentation/browser/edge/edge-index-during-play.png) | ![screenshot]() | Works as expected |
| Instructions.html | ![screenshot](documentation/browser/chrome/chrome-instruction.png) | ![screenshot](documentation/browser/firefox/firefox-instructions.png) | ![screenshot](documentation/browser/safari/safari-instructions.png) |  ![screenshot](documentation/browser/edge/edge-instructions.png) | ![screenshot]() | Works as expected |
