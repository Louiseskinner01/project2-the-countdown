...
| --- | --- | --- | --- | --- | --- |
|  | [404.html](https://github.com/Louiseskinner01/project2-the-countdown/blob/main/404.html) | [HTML Validator](https://validator.w3.org/nu/?doc=https://louiseskinner01.github.io/project2-the-countdown/404.html) | ![screenshot](documentation/validation/html/html-404-errors.png) | ![screenshot](documentation/validation/html/html-404-valid.png) | Examples of erros that were preventing this page from passing validation are:<br>stray / at the end of tags e.g `    <meta charset="UTF-8" />`. By removing the unnecessary white space, the error was easily fixed. |
...
|  | [registration.html](https://github.com/Louiseskinner01/project2-the-countdown/blob/main/registration.html) | [HTML Validator](https://validator.w3.org/nu/?doc=https://louiseskinner01.github.io/project2-the-countdown/registration.html) | ![screenshot](documentation/validation/html/html-registration-erros.png) | ![screenshot](documentation/validation/html/html-registration-valid.png) | There was an anchor tag that was a child element of the submit button: this is not good practice.
 To fix this I removed the anchor tag and added a url to the form action attribute in to the registration form like this `action="form-submitted.html"`. |
